				...
				<div class="box">
					...
					<div class="box-header with-border">
						...
						<div class="pull-right">
							<a href="<?php echo base_url(ADMIN_PATH."add-banner/"); ?>" class="btn btn-primary">
					...
					<div class="box-body">
						<div class="col-xs-12">
							...
							<form method="post">
								<table id="tableBanner" class="display table-responsives" cellspacing="0" width="100%">
									<thead>
										<tr>
...
$(document).ready(function() {
	...
	$('#tableBanner').DataTable({ 
        ...
        "order": [],
		"ajax": {
            "url": BASE_URL_ADMIN + "banner-data-list/",
            "type": "POST"
        },
		"columnDefs": [
			{ 
...
function deleteData() {
	...
	if(ids == '' || ids == null) {
		...
		$.ajax({
			url: BASE_URL_ADMIN + "delete-banner/",
			type: "POST",
			async: false,
			data: form_data,
			dataType: "json",
