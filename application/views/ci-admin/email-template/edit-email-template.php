						...
						<div class="col-lg-8">
							...
							<form method="post">
								...
								<div class="row form-group">
									...
									<div class="col-xs-8">
										<input type="text" class="form-control" id="subject" name="subject" placeholder="Subject" value="<?php echo $subject; ?>" tabindex="1" />
									</div>
								</div>
								<div class="row form-group">
									<div class="col-xs-4">
									...
									<div class="col-xs-8">
										<textarea class="form-control" id="message" name="message" placeholder="Message" tabindex="2"><?php echo $message; ?></textarea>
									</div>
								</div>
								<div class="row form-group">
									<div class="col-xs-4">
								...
								<div class="row form-group">
									<div class="col-xs-6 col-md-4">
										<button type="button" class="btn btn-primary btn-block" id="btnEditEmailTemplate" tabindex="4" onclick="EditEmailTemplate();">Save</button>
									</div>
									<div class="col-xs-6 col-md-4">
...
var btnEditEmailTemplateID = "#btnEditEmailTemplate";
var uriID = "#uri";
...
function EditEmailTemplate() {
	...
	btnDisabled(btnEditEmailTemplateID);
	...
	if(subject == '' || subject == null) {
		...
		btnEnabled(btnEditEmailTemplateID);
		getFocus(subjectID);
	...
	$.ajax({
		url: BASE_URL_ADMIN + "update-email-template/",
		type: "POST",
		async: false,
		data: form_data,
		dataType: "json",
		success: function(json_response) {
			...
			if(response === "true") {
				...
				$(errorID).html(msg);
				$(btnEditEmailTemplateID).html(loaderText);
